...
<template>
 ...
 <WelcomeItem>
  ...
  <RouterLink ckass="text-blue-500 hover:underline" to="/archives">点击查看我的文章</RouterLink>
</WelcomeItem>
  <WelcomeItem>
    <template #icon>
      <SkillIcon />
